...
if ("$CPU" = "CPU2") then
  ...
  oneFileMID = 0x0A02
  xFileMID = 0x0A03
  seqTimeFileMID = 0x0A04
  timeSeqFileMID = 0x0A05
elseif ("$CPU" = "CPU3") then
  ...
  oneFileMID = 0x0802
  xFileMID = 0x0803
  seqTimeFileMID = 0x0804
  timeSeqFileMID = 0x0805
endif

;; Setup the Destination File Table
$SC_$CPU_DS_DF_TBL_Description  = "Move File Test"

;; Entry 1
$SC_$CPU_DS_DF_TBL[0].MoveDirName = "/ram/movedir/"
...
$SC_$CPU_DS_DF_TBL[0].FileAge = 100
$SC_$CPU_DS_DF_TBL[0].SeqCnt = 100

;; Entry 2
$SC_$CPU_DS_DF_TBL[1].MoveDirName = "/ram/movedir/"
...
$SC_$CPU_DS_DF_TBL[1].FileAge = 100
$SC_$CPU_DS_DF_TBL[1].SeqCnt = 200

;; Entry 3
$SC_$CPU_DS_DF_TBL[2].MoveDirName = "/ram/movedir/"
...
$SC_$CPU_DS_DF_TBL[2].FileAge = 100
$SC_$CPU_DS_DF_TBL[2].SeqCnt = 300

;; Entry 4
$SC_$CPU_DS_DF_TBL[3].MoveDirName = "/ram/movedir/"
...
$SC_$CPU_DS_DF_TBL[3].FileAge = 100
$SC_$CPU_DS_DF_TBL[3].SeqCnt = 400

;; Entry 5
$SC_$CPU_DS_DF_TBL[4].MoveDirName = "/ram/movedir/"
...
;; Entry 6
$SC_$CPU_DS_DF_TBL[5].MoveDirName = "/ram/movedir/"
...
;; Entry 7
$SC_$CPU_DS_DF_TBL[6].MoveDirName = "/ram/movedir/"
...
;; Entry 8
$SC_$CPU_DS_DF_TBL[7].MoveDirName = "/ram/movedir/"
...
s create_tbl_file_from_cvt("$CPU",fileAppid,"Move File Test File Table","ds_movefile.tbl",fileTblName,"$SC_$CPU_DS_DF_TBL_Description",endmnemonic)

;; Setup the Packet Filter Table
$SC_$CPU_DS_PF_TBL_Description  = "Move File Test"
;; Entry 1
...
s create_tbl_file_from_cvt("$CPU",filterAppid,"Move File Test Filter Table","ds_movefilter.tbl",filterTblName,"$SC_$CPU_DS_PF_TBL_Description",endmnemonic)

%liv (log_procedure) = logging

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_ds_tbl4"
write ";*********************************************************************"
ENDPROC
