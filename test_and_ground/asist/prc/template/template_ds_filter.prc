...
for i = 0 to DS_FILTERS_PER_PACKET-1 do
  ...
  if (seqFileName <> "") then
    ...
    s ftp_file(ramDir, seqFileName, seqFileName, "$CPU", "G")
  else
  ...
  if (timeFileName <> "") then
    ...
    ;; Need to parse the filename out of the variable above
    ;; before using it in the ftp_file call below
    s ftp_file(ramDir, timeFileName, timeFileName, "$CPU", "G")
  else
    ut_setrequirements DS_3003, "F"
    ut_setrequirements DS_3004, "F"
  endif
...
write ";***********************************************************************"
;; Dump the Packet Filter Table
s get_tbl_to_cvt (ramDir,filterTblName,"A","$cpu_filtertbl27","$CPU",filterTblPktId)
...
write ";***********************************************************************"
;; Dump the Packet Filter Table
s get_tbl_to_cvt (ramDir,filterTblName,"A","$cpu_filtertbl2133","$CPU",filterTblPktId)
...
write ";***********************************************************************"
;; Dump the Packet Filter Table
s get_tbl_to_cvt (ramDir,filterTblName,"A","$cpu_filtertbl2163","$CPU",filterTblPktId)
...
write ";***********************************************************************"
;; Dump the Packet Filter Table
s get_tbl_to_cvt (ramDir,filterTblName,"A","$cpu_filtertbl32","$CPU",filterTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000008038F"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000008038F"
endif
...
write ";***********************************************************************"
;; Dump the Packet Filter Table
s get_tbl_to_cvt (ramDir,filterTblName,"A","$cpu_filtertbl37","$CPU",filterTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000008049E"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000008049E"
endif
...
write ";***********************************************************************"
;; Dump the Packet Filter Table
s get_tbl_to_cvt (ramDir,filterTblName,"A","$cpu_filtertbl312","$CPU",filterTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc000000C058A"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc000000C058A"
endif
...
write ";*********************************************************************"
;; Dump the Packet Filter Table
s get_tbl_to_cvt (ramDir,filterTblName,"A","$cpu_filtertbl42","$CPU",filterTblPktId)
...
s ftp_file("CF:0/apps", "ds_fullfilter.tbl", filterFileName, "$CPU", "P")
