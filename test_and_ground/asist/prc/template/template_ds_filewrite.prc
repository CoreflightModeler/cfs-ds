...
s ftp_file("CF:0/apps", "ds_fwfile.tbl", destFileName, "$CPU", "P")
s ftp_file("CF:0/apps", "ds_fwfilter.tbl", filterFileName, "$CPU", "P")
...
s get_tbl_to_cvt (ramDir,filterTblName,"A","$cpu_filtertbl211","$CPU",filterTblPktId)
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl211","$CPU",fileTblPktId)
...
if ($SC_$CPU_DS_FileState[seqFileEntry].FileName <> "") then
  ...
  if (fileName1 <> "") then
    ...
    s ftp_file(ramDir, fileName1, fileName1, "$CPU", "G")
  else
...
if ($SC_$CPU_DS_FileState[seqFileEntry].FileName <> "") then
  ...
  if (fileName2 <> "") then
    ...
    ;; Need to parse the filename out of the variable above
    ;; before using it in the call below
    s ftp_file(ramDir, fileName2, fileName2, "$CPU", "G")
  else
    write "<!> Failed (3003;3004) - Filename not specified. Could not download."
    ut_setrequirements DS_3003, "F"
    ut_setrequirements DS_3004, "F"
...
if (fileName3 <> "") then
  ...
  ;; Need to parse the filename out of the variable above
  ;; before using it in the call below
  s ftp_file(ramDir, fileName3, fileName3, "$CPU", "G")
else
  write "<!> Failed (3003;3004) - Filename not specified. Could not download."
  ut_setrequirements DS_3003, "F"
  ut_setrequirements DS_3004, "F"
...
s load_table("ds_fwfile.tbl","$CPU")
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc00000060E95"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc00000060E95"
endif
...
write ";*********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl35","$CPU",fileTblPktId)
...
write ";*********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl38","$CPU",fileTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc000004609EB"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc000004609EB"
endif
...
write ";***********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl313","$CPU",fileTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc000000A0DE2"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc000000A0DE2"
endif
...
write ";***********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl318","$CPU",fileTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000006079C"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000006079C"
endif
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000005079C00000003"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000005079C00000003"
endif
...
write ";***********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl323","$CPU",fileTblPktId)
...
write ";***********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl328","$CPU",fileTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000006069C"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000006069C"
endif
...
write ";***********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl333","$CPU",fileTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000046089C"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000046089C"
endif
...
if (fileName1 <> "") then
  ...
  ;; Need to parse the filename out of the variable above
  ;; before using it in the call below
  s ftp_file("CF:0", fileName1, fileName1, "$CPU", "G")
endif
...
write ";***********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl338","$CPU",fileTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc000000E0A9C"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc000000E0A9C"
endif
...
write ";***********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl343","$CPU",fileTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc000000A0B9C"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc000000A0B9C"
endif
...
write ";***********************************************************************"
;; Dump the Destination File Table
s get_tbl_to_cvt (ramDir,fileTblName,"A","$cpu_filetbl347","$CPU",fileTblPktId)
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc000000A0C9C"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc000000A0C9C"
endif
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000004029C"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000004029C"
endif
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000002029C"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000002029C"
endif
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000003029C0002"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000003029C0002"
endif
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000002119C"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000002119C"
endif
